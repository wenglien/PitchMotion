...
from src.get_pitch_frames_yolov8 import get_pitch_frames_yolov8, _get_video_fps_ffprobe
...
from pitch_classifier import PitchFeatureExtractor, RuleBasedClassifier
    ...
    *,
    ...
    if not os.path.isfile(weights_path):
        raise FileNotFoundError(
            ...
            "請先依照 yolov8/train_yolo26.py 完成訓練（YOLO26n，比 YOLOv8 快 43%）。"
        )
